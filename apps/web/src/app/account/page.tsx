...
import { User, Mail, Shield, LogOut, ChevronRight, Settings, ExternalLink } from 'lucide-react';
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="md:col-span-2 space-y-6">
                        ...
                        {/* Other Links */}
                        <div className="flex justify-center md:justify-start space-x-6 text-sm text-gray-400 font-medium py-4">
